...
function makeLocalCity() {
  ...
  fam({
    ...
    { prompt: "はると「地図記号は地図ごとにちがう」。みお「地図記号は国じゅうで同じものが使われている」。正しいのはどっち？", correct: "みおだけ正しい", explanation: "地図記号は全国共通の決まった形で使われています。" },
    { prompt: "はると「田と畑の地図記号はちがう形をしている」。みお「地図記号には、田・畑のほかに果樹園や工場を表すものもある」。正しいのはどっち？", correct: "二人とも正しい", explanation: "田は稲を刈ったあとの形、畑は植物の芽の形でちがう記号です。地図記号には、田・畑のほかにも果樹園や工場などを表す記号があります。" },
    { prompt: "はると「市役所は警察と同じ仕事をしている」。みお「市役所は店の一種だ」。正しいのはどっち？", correct: "二人ともまちがい", explanation: "市役所は住民のくらしに関わる仕事をする公共のしせつで、店でも警察でもありません。" },
    { prompt: "はると「地図を見れば、実際に行くよりくわしくわかる」。みお「地図では何もわからない」。正しいのはどっち？", correct: "二人ともまちがい", explanation: "地図からは土地の使われ方や施設の場所など多くのことがある程度わかりますが、実際に行って確かめることでさらにくわしくわかります。" },
...
function makeLocalWork() {
  ...
  fam({
    ...
    { prompt: "はると「どこで作られた商品を買っても同じ」。みお「地元の商品を買うと、地域の仕事を応援できる」。正しいのはどっち？", correct: "みおだけ正しい", explanation: "地元の商品を買うことは、その地域の生産者や店を支えることにつながります。" }
  ]);
  ...
  fam({
    ...
    { prompt: "はると「食品工場では衛生に気をつけて作業している」。みお「食品工場では、機械を清潔にたもつことにも気をつけている」。正しいのはどっち？", correct: "二人とも正しい", explanation: "食品工場では、白い服やぼうしを身につけたり、機械を清潔にたもったりして衛生に気をつけています。" },
    { prompt: "はると「野菜は運ぶのに時間がかかるほど新鮮になる」。みお「野菜はいつ運んでも同じ」。正しいのはどっち？", correct: "二人ともまちがい", explanation: "新鮮さを保つために、温度管理やすばやい輸送などの工夫がされています。運ぶ時間が長いほど新鮮になるわけではありません。" },
    { prompt: "はると「機械を使う仕事にも、人の手が必要な部分がある」。みお「機械を使うと、同じ作業を早く正確にくり返せる」。正しいのはどっち？", correct: "二人とも正しい", explanation: "機械化が進んでも点検や管理など人の手が必要な仕事があり、また機械は同じ作業を早く正確にくり返すのが得意です。" }
  ]);
  ...
  fam({
    ...
    { prompt: "はると「お米や野菜は、農家がいなくても工場だけで作れる」。みお「農家がいなくてもくらしは変わらない」。正しいのはどっち？", correct: "二人ともまちがい", explanation: "農家の仕事はわたしたちの食生活を支える大切な仕事で、農家がいなければお米や野菜は手に入りにくくなります。" },
    { prompt: "はると「商品はどこで作られても、運ばなくても店にならぶ」。みお「運送は仕事のうちに入らない」。正しいのはどっち？", correct: "二人ともまちがい", explanation: "運送の仕事のおかげで、遠くの産地で作られた商品を近くの店で買うことができます。" }
  ]);
...
function makeSafetyLife() {
  ...
  fam({
    ...
    { prompt: "はると「訓練をしてもしなくても同じ」。みお「訓練をしておくと、実さいの災害のときに落ち着いて行動しやすい」。正しいのはどっち？", correct: "みおだけ正しい", explanation: "訓練をしておくことで、いざというときに落ち着いて行動しやすくなります。" },
    { prompt: "はると「交通のきまりを守ることは、自分だけでなく周りの安全も守ることになる」。みお「信号を守ることも、交通のきまりの一つだ」。正しいのはどっち？", correct: "二人とも正しい", explanation: "きまりを守ることは自分自身だけでなく周りの人の安全にもつながり、信号を守ることもその一つです。" }
  ]);
  ...
  fam({
    ...
    { prompt: "はると「集団で行っても一人で行っても安全さは同じ」。みお「集団登下校は、一人で行くより安全性が高まる」。正しいのはどっち？", correct: "みおだけ正しい", explanation: "集団で行動することで、お互いに気をつけ合い安全性が高まります。" },
    { prompt: "はると「こども110番の家は、こまったときにだれでもかけこめる」。みお「こども110番の家は、地域の人が協力して行っている取り組みだ」。正しいのはどっち？", correct: "二人とも正しい", explanation: "こども110番の家はこまったときにかけこめる場所で、地域の人が協力して行っている取り組みでもあります。" }
  ]);
  ...
  fam({
    ...
    { prompt: "はると「子どもも、あいさつや周りへの注意で地域の安全に協力できる」。みお「知らない人に声をかけられたら、大人に知らせることも安全への協力になる」。正しいのはどっち？", correct: "二人とも正しい", explanation: "あいさつや周りへの注意、こまったことを大人に知らせることなど、子どもにもできる地域の安全への協力があります。" },
    { prompt: "はると「安全を守るのは消防だけの仕事だ」。みお「安全を守るのは警察だけの仕事だ」。正しいのはどっち？", correct: "二人ともまちがい", explanation: "安全は、学校・警察・消防・地域の人など、いろいろな立場の人が協力して守っています。" }
  ]);
...
function makeCityChange() {
  ...
  fam({
    ...
    { prompt: "はると「年表がなくても順番はいつでもわかる」。みお「年表を使うと、できごとの順番がわかりやすい」。正しいのはどっち？", correct: "みおだけ正しい", explanation: "年表は、できごとを時間の順に整理して見やすくする資料です。" }
  ]);
  ...
  fam({
    ...
    { prompt: "はると「今の道具はこれ以上変わらない」。みお「今べんりな道具も、いつかまた新しいものに変わっていくかもしれない」。正しいのはどっち？", correct: "みおだけ正しい", explanation: "道具や技術はこれからも変化を続けていくと考えられます。" }
  ]);

...
function makeKanjiReading() {
  ...
  fam({
    ...
    { prompt: "「二十日」の読み方。はると「はつか」。みお「にじゅうにち」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "日づけの「二十日」は「はつか」と読みます。" },
    { prompt: "「坂を下る」の読み方。はると「くだる」。みお「さがる」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "「下る」は「くだる」です。「さがる」と読むのは「下がる」のときです。" }
  ]);
...
function makeDictionary() {
  ...
  fam({
    ...
    { prompt: "はると「カタカナの言葉も国語辞典にのっている」。みお「カタカナの言葉はのっていない」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "「テレビ」「パン」のようなカタカナの言葉ものっています。" },
    { prompt: "「食べる」の調べ方。はると「『た』の場所でさがす」。みお「漢字の画数でさがす」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "国語辞典は音の順なので「た」でさがします。画数で引くのは漢字辞典です。" },
    { prompt: "はると「同じ言葉に意味がいくつものっていることがある」。みお「1つの言葉の意味は1つだけ」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "「あがる」のように、1つの言葉にいくつもの意味がのっていることがあります。" }
  ]);
...
function makeOnKun() {
  ...
  fam({
    ...
    { prompt: "はると「辞典では音読みをカタカナ、訓読みをひらがなで書くことが多い」。みお「その反対だ」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "辞典では音読みはカタカナ、訓読みはひらがなで書き分けられています。" },
...
function makePronouns() {
  ...
  fam({
    ...
    { prompt: "はると「こそあど言葉を使うと、同じ言葉のくりかえしをさけられる」。みお「使うと文はかならず長くなる」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "「子犬は…子犬は…」とくり返すかわりに「それ」と言えて、文はむしろ短くなります。" }
  ]);
...
function makeConnectives() {
  ...
  fam({
    ...
    { prompt: "はると「つなぎ言葉をかえると、文の意味が変わることがある」。みお「どのつなぎ言葉を使っても意味は同じ」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "「だから勝った」と「しかし負けた」のように、つなぎ言葉で意味が変わります。" }
  ]);
...
function makeRomaji() {
  ...
  fam({
    ...
    { prompt: "「し」の書き方。はると「shiともsiとも書ける」。みお「shiだけが正しい」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "「し」はsiとshiの2つの書き方があり、どちらも使われます。" },
    { prompt: "はると「のばす音には記号(^など)をつけて書くことがある」。みお「のばす音は書かなくてよい」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "「おかあさん」のようなのばす音は、記号をつけて表すことがあります。" },
    { prompt: "はると「日本の地名や人の名前もローマ字で書ける」。みお「ローマ字で書けるのは英語だけ」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "ローマ字は日本語の音を書く文字なので、地名や名前も書けます。" }
  ]);

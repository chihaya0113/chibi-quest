...
function makeNatureObservation() {
  ...
  fam({
    ...
    { prompt: "はると「観察した生き物はもとの場所にもどす」。みお「観察した生き物は全部持ち帰ってよい」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "生き物のくらしを守るため、むやみに持ち帰らずもとの場所にもどします。" },
...
function makePlantsGrowth() {
  ...
  fam({
    ...
    { prompt: "はると「同じ種類の植物でも、育つ環境がちがうと大きさが変わることがある」。みお「同じ種類なら必ず同じ大きさに育つ」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "日光や水などの条件によって、同じ種類でも育ち方に差が出ることがあります。" },
    { prompt: "はると「植物にとって日光は成長に関係がある」。みお「日光は植物の成長に関係ない」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "植物は日光を使って、育つための養分をつくります。" },
    { prompt: "はると「植物の高さは、まいた日から少しずつ変わっていく」。みお「植物の高さはたねをまいた日からずっと同じ」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "植物は時間とともに少しずつ成長し、高さが変わっていきます。" }
  ]);
...
function makeInsectsGrowth() {
  ...
  fam({
    ...
    { prompt: "はると「クモはこん虫ではない」。みお「クモは足が8本だからこん虫だ」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "こん虫は足が6本ですが、クモは足が8本なのでこん虫ではありません。" },
    { prompt: "はると「幼虫が食べるものは、こん虫のくらしを知る手がかりになる」。みお「幼虫が食べるものは関係ない」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "食べ物は生き物のくらしと関係しています。" }
  ]);
...
function makeSound() {
  ...
  fam({
    ...
    { prompt: "はると「ふるえが大きいほど音は大きくなる」。みお「ふるえが大きいほど音は必ず高くなる」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "ふるえの大きさは音の大きさに関係し、ふるえの速さが音の高さに関係します。" },
    { prompt: "はると「音が出ているものにはふるえがある」。みお「音が出ていてもふるえていないことがある」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "音はふるえによって出るので、音が出ているものは必ずふるえています。" }
  ]);
...
function makeAnimalHomes() {
  ...
  fam({
    ...
    { prompt: "はると「生き物のすみかは、食べ物やかくれ場所と関係がある」。みお「生き物のすみかは、たまたま決まる」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "生き物のすみかは、食べ物やかくれ場所などの条件と関係があります。" },
    { prompt: "はると「体の色は敵から身を守ることに関係することがある」。みお「体の色はすみかとまったく関係ない」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "体の色がすみかの環境に似ていると、敵に見つかりにくくなることがあります。" },
    { prompt: "はると「すみかを観察するときも、生き物への配慮が必要だ」。みお「観察のためなら生き物のすみかをこわしてもよい」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "観察をするときも、生き物のくらしやすみかを大切にすることが必要です。" }
  ]);
...
function makeGroundSun() {
  ...
  fam({
    ...
    { prompt: "はると「太陽の位置が変わると影の向きも変わる」。みお「影の向きは太陽の位置と関係ない」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "太陽の位置が変わると、影の向きも変わります。" },
    { prompt: "はると「日光が当たる時間が長いほど地面はあたたまりやすい」。みお「日光の当たる時間は地面の温度に関係ない」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "日光が長く当たるほど、地面はあたたまりやすくなります。" }
  ]);
...
function makeSunlight() {
  ...
  fam({
    ...
    { prompt: "はると「虫めがねで日光を集めるとき、強い光を直接見てはいけない」。みお「集めた光をじっくり見て確かめるとよい」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "強い光を直接見ると目に危険なので、見ないようにします。" },
  ...
  fam({
    ...
    { prompt: "はると「虫めがねが大きいほど、多くの日光を集められる」。みお「虫めがねの大きさは日光の量に関係ない」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "レンズが大きいほど、より多くの日光を集めることができます。" },
    { prompt: "はると「黒い紙は白い紙より日光を吸収しやすい」。みお「紙の色は日光の吸収に関係ない」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "黒い色は光を多く吸収し、あたたまりやすい性質があります。" }
  ]);
...
function makeElectricPath() {
  ...
  fam({
    ...
    { prompt: "はると「金属はほとんど電気を通す」。みお「金属はすべて電気を通さない」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "鉄・銅・アルミニウムなど、多くの金属は電気を通します。" },
    { prompt: "はると「回路が1か所でも切れると豆電球はつかない」。みお「回路の一部が切れていても豆電球はつく」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "回路のどこか1か所でも切れていると、電気は流れず豆電球はつきません。" }
  ]);
...
function makeMagnets() {
  ...
  fam({
    ...
    { prompt: "はると「磁石の働きは、近づける材料や極によって変わる」。みお「磁石の働きはいつも同じ」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "磁石の働きは、近づける材料や極によって変わります。" }
  ]);
...
function makeWeight() {
  ...
  fam({
    ...
    { prompt: "はると「形を変えても、ものの量が同じなら重さは変わらない」。みお「形を変えると必ず重さも変わる」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "形を変えても、量が同じであれば重さは変わりません。" },
    { prompt: "はると「同じ体積でも材料によって重さがちがうことがある」。みお「同じ体積なら材料が何でも重さは同じ」。正しいのはどっち？", correct: "はるとだけ正しい", explanation: "同じ体積でも、材料によって重さが違うことがあります。" }
  ]);

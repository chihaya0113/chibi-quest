...
const CACHE_VERSION = "chibi-quest-v36";
...
const PRECACHE = [
  ...
  "./src/app.js?v=36",
  "./src/styles.css?v=36",
  "./src/curriculum.js?v=36",
  "./src/storage.js?v=36",
  "./src/battleHighlights.js?v=36",
  "./src/data/soccer/highlightScenes.js?v=36",
  ...
  "./src/data/soccer/players.js?v=36"
];

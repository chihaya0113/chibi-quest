...
const CACHE_VERSION = "chibi-quest-v45";
...
const PRECACHE = [
  ...
  "./src/app.js?v=45",
  "./src/styles.css?v=45",
  "./src/curriculum.js?v=45",
  "./src/storage.js?v=45",
  "./src/battleHighlights.js?v=45",
  "./src/data/soccer/highlightScenes.js?v=45",
  ...
  "./src/data/soccer/players.js?v=45"
];

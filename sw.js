...
const CACHE_VERSION = "chibi-quest-v41";
...
const PRECACHE = [
  ...
  "./src/app.js?v=41",
  "./src/styles.css?v=41",
  "./src/curriculum.js?v=41",
  "./src/storage.js?v=41",
  "./src/battleHighlights.js?v=41",
  "./src/data/soccer/highlightScenes.js?v=41",
  ...
  "./src/data/soccer/players.js?v=41"
];

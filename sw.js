...
const CACHE_VERSION = "chibi-quest-v43";
...
const PRECACHE = [
  ...
  "./src/app.js?v=43",
  "./src/styles.css?v=43",
  "./src/curriculum.js?v=43",
  "./src/storage.js?v=43",
  "./src/battleHighlights.js?v=43",
  "./src/data/soccer/highlightScenes.js?v=43",
  ...
  "./src/data/soccer/players.js?v=43"
];

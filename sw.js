...
const CACHE_VERSION = "chibi-quest-v42";
...
const PRECACHE = [
  ...
  "./src/app.js?v=42",
  "./src/styles.css?v=42",
  "./src/curriculum.js?v=42",
  "./src/storage.js?v=42",
  "./src/battleHighlights.js?v=42",
  "./src/data/soccer/highlightScenes.js?v=42",
  ...
  "./src/data/soccer/players.js?v=42"
];

...
const CACHE_VERSION = "chibi-quest-v38";
...
const PRECACHE = [
  ...
  "./src/app.js?v=38",
  "./src/styles.css?v=38",
  "./src/curriculum.js?v=38",
  "./src/storage.js?v=38",
  "./src/battleHighlights.js?v=38",
  "./src/data/soccer/highlightScenes.js?v=38",
  ...
  "./src/data/soccer/players.js?v=38"
];

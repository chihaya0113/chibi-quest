...
const CACHE_VERSION = "chibi-quest-v44";
...
const PRECACHE = [
  ...
  "./src/app.js?v=44",
  "./src/styles.css?v=44",
  "./src/curriculum.js?v=44",
  "./src/storage.js?v=44",
  "./src/battleHighlights.js?v=44",
  "./src/data/soccer/highlightScenes.js?v=44",
  ...
  "./src/data/soccer/players.js?v=44"
];
